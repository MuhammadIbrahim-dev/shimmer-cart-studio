      ...
      <div className="container-custom py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-muted-foreground mb-4">Get the latest updates on new products and special sales</p>
            <form className="flex">
              <input
                type="email"
                placeholder="Your email address"
                className="flex-1 p-2 rounded-l-md border border-gray-200 focus:outline-none focus:ring-2 focus:ring-primary"
              />
              <button 
                type="submit" 
        ...
        <div className="border-t border-gray-100 mt-8 pt-8 text-center text-muted-foreground">
